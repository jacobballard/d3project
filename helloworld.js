...
var drawSingle=function(data)
{
  ...
  var drawSingleHW=function(data)
  {
    ...
    line.append("line")
        ...
        .classed("hidden",false)
        .attr("x1", 0)
        .attr("y1", yScale(getaveHW(data[0])/2))
        .attr("x2", xScale(data[0].homework.length-1))
        .attr("y2", yScale(getaveHW(data[0])/2))
        .attr("fill","none")
        .attr("stroke", color(3))
  ...
  var drawSingleQuiz=function(data)
  {
    ...
    line.append("line")
        .attr("id","QuizMeanLine")
        .classed("hidden",false)
        .attr("x1", 0)
        .attr("y1", yScale(getaveQuiz(data[0])/10))
        .attr("x2", xScale(data[0].quizes.length-1))
        .attr("y2", yScale(getaveQuiz(data[0])/10))
        .attr("fill","none")
        .attr("stroke", color(3))
        .attr("stroke-width", 1.5);
    legend=svg.append("g")
       .attr("id","meanLegend")
       .attr('transform', 'translate(' +(width*1.5)+ ',' + margins.top + ')')
    legend.append("rect")
          .attr("x",0)
          .attr("y",0)
          .attr("width",10)
...
var updateSingle=function(data)
{
  ...
  var updateSingleHW=function(data)
  {
    ...
    dot.selectAll("circle")
       ...
       .attr("r","4")
       .attr("fill",color(1))
    line.select("#HWMeanLine")
        .classed("hidden",false)
        .transition()
        .duration(1000)
        .attr("x1", 0)
        .attr("y1", yScale(getaveHW(data)/2))
        .attr("x2", xScale(data.homework.length-1))
        .attr("y2", yScale(getaveHW(data)/2))
        .attr("fill","none")
        .attr("stroke", color(3))
        .attr("stroke-width", 1.5);
  ...
  var updateSingleQuiz=function(data)
  {
    ...
    dot.selectAll("circle")
       ...
       .attr("r","4")
       .attr("fill",color(1))
    line.select("#QuizMeanLine")
        .classed("hidden",false)
        .transition()
        .duration(1000)
        .attr("x1", 0)
        .attr("y1", yScale(getaveHW(data)/10))
        .attr("x2", xScale(data.quizes.length-1))
        .attr("y2", yScale(getaveHW(data)/10))
        .attr("fill","none")
        .attr("stroke", color(3))
        .attr("stroke-width", 1.5);
  }
